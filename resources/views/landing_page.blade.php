...
<body>
    <h1 class="site-heading text-center text-faded d-none d-lg-block">
        <span class="site-heading-upper text-bs-gray-100 mb-3">Rasa Yang Pernah Ada</span>
        <span class="site-heading-lower">Coffee Shop</span>
    </h1>

    <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
        <div class="container">
            <a class="navbar-brand text-uppercase fw-bold d-lg-none text-bs-gray-100" href="index.html">Rasa Yang Pernah Ada</a>
